...
function createRandomDataTxt(numberOfSamples: number) {
    ...
    for(let i = 0; i < Math.ceil(numberOfSamples/2); i++) {
        mockData+= `c${i}, ${Math.ceil(Math.random()*45 - 5)}, ${Math.ceil(Math.random()*45 - 5)},  ${Math.ceil(Math.random()*45 - 5)}, ${Math.ceil(Math.random()*5)}\n`;
    }
    ...
    for(let i =  Math.ceil(numberOfSamples/2); i <  Math.ceil(numberOfSamples/2 + numberOfSamples/3); i++) {
        mockData+= `c${i}, ${Math.ceil(Math.random()*45 - 5)}, ${Math.ceil(Math.random()*45 - 5)},  ${Math.ceil(Math.random()*45 - 5)}, ${Math.ceil(Math.random()*5 + 5)}\n`;
    }
